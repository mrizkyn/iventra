...
const paymentForm = useForm({
    ...
    amount_paid:
        props.sale.remaining_receivable > 0
            ? props.sale.remaining_receivable
            : 0,
...
const getReturnedQty = (productId) => {
    if (!props.sale.returns || props.sale.returns.length === 0) {
        return 0;
    }

    let total = 0;
    props.sale.returns.forEach((ret) => {
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p
                                v-if="sale.approved_at && sale.user"
                                class="text-xs text-gray-500 dark:text-gray-400"
                            >
                                by {{ sale.user.name }} on
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <SecondaryButton
                            v-if="
                                sale.remaining_receivable > 0 &&
                                sale.return_status !== 'Fully Returned'
                            "
                            @click="
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        >
                            ...
                            <p class="text-xl font-bold text-red-500">
                                {{ formatCurrency(sale.remaining_receivable) }}
                            </p>
                        </div>
                    </div>
